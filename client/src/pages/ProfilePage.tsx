        ...
        <div className="glass-strong mb-6 flex flex-col items-center gap-4 rounded-3xl p-6">
          <div className="relative">
            ...
            <button
              ...
              className="glass absolute -bottom-1 -right-1 grid h-9 w-9 place-items-center rounded-full text-sm text-slate-600 transition-transform hover:scale-105 active:scale-95 dark:text-slate-200"
            >
            ...
            {tabs.map((t) => (
              <button
                ...
                className={`rounded-xl px-2 py-2 transition-colors ${
                  tab === t.key ? 'bg-brand-500/20' : 'hover:bg-white/60 dark:hover:bg-slate-700/50'
                }`}
              >
