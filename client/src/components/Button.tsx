...
const variants: Record<Variant, string> = {
  primary: 'btn-glossy border-brand-500/40 bg-brand-500/20 text-brand-700 hover:brightness-105 dark:border-brand-400/40 dark:bg-brand-500/25 dark:text-brand-200',
