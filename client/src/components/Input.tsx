  ...
  return (
    <label className="block text-left">
      ...
      <motion.div animate={error ? { x: [0, -8, 8, -4, 4, 0] } : {}} transition={{ duration: 0.35 }}>
        <input
          className={`h-11 w-full rounded-xl border bg-white/80 px-3.5 text-sm text-slate-800 outline-none transition-colors backdrop-blur-md placeholder:text-slate-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:bg-slate-800/80 dark:text-slate-100 dark:border-slate-700 ${
