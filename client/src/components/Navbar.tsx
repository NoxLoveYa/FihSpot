...
export function Navbar({ mapType, onMapTypeChange, search }: NavbarProps) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[1200] flex flex-wrap items-center justify-between gap-x-1 gap-y-2 px-2 py-2 lg:pointer-events-none lg:flex-nowrap lg:gap-2 lg:px-3 lg:py-3">
